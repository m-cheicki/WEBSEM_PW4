...
//		 create an empty model
     ...
     * @return RDFNode
     */
    static public RDFNode getValueOfObjectProperty(Model model, String namespace, String object, String property) {
    	return getValueofProperty(model, namespace, object, property).getObject(); 
    }
    ...
    /**
     * Gets the value of the property for a given datatype. 
     * @param model
     * @param namespace
     * @param object
     * @param property
